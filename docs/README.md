...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-30 22:56:50 UTC<br>状态：成功</p>
</section>
...
<p>今日速读4篇论文，聚焦随机化学应网络建模与因果推断方法。</p>
<p>最值关注：随机化学应网络的降阶建模（7.0分）及多参数扰动敏感性通用方法。</p>
<p>建议下一步精读化学应网络相关高分论文，深入理解其建模细节。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Data-driven Effective Modeling of Stochastic Chemical Reaction Networks">Data-driven Effective Modeling of Stochastic Chemical Reaction Networks</span></li><li><span class="dpr-home-dashboard-paper-title" title="Barycentric Fused Gromov-Wasserstein Balancing for Causal Inference under Multiple Treatments">Barycentric Fused Gromov-Wasserstein Balancing for Causal Inference under Multiple Treatments</span></li><li><span class="dpr-home-dashboard-paper-title" title="A general-purpose sensitivity method for multiple simultaneous parameter perturbations in stochastic reaction networks">A general-purpose sensitivity method for multiple simultaneous parameter perturbations in stochastic reaction networks</span></li></ul>
  </div>
