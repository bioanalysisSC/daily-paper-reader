...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-01 00:38:22 UTC<br>状态：成功</p>
</section>
...
<p>今日聚焦蛋白质表示学习的高阶上位效应探测，并覆盖跨物种基因预测与分子多模态建模。</p>
<p>最值得关注的是精读论文《Beyond Tokens》揭示的蛋白质表示中非加性交互信息，以及《Homo-RAG》用同源引导检索增强实现跨物种基因功能预测。</p>
<p>建议顺着“表示学习+检索增强”的思路，可继续关注多模态分子模型与基因型-表型关系图的应用潜力。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Beyond Tokens: Probing Higher-Order Epistasis in Learned Protein Representations">Beyond Tokens: Probing Higher-Order Epistasis in Learned Protein Representations</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">gene-perturb <strong>1</strong></span></div>
</section>
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Homo-RAG: Homology-Guided Retrieval-Augmented Generation for Cross-Species Gene Function Prediction">Homo-RAG: Homology-Guided Retrieval-Augmented Generation for Cross-Species Gene Function Prediction</span></li><li><span class="dpr-home-dashboard-paper-title" title="Mol-JEPA: A multimodal Joint Embedding Predictive Architecture for Molecules">Mol-JEPA: A multimodal Joint Embedding Predictive Architecture for Molecules</span></li><li><span class="dpr-home-dashboard-paper-title" title="Global geometry of the genotype-phenotype map illuminates a trade-off between penetrance and mutational adaptability">Global geometry of the genotype-phenotype map illuminates a trade-off between penetrance and mutational adaptability</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">gene-perturb <strong>4</strong></span></div>
</section>
</div>
